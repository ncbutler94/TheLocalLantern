...
/**
 * TrendingMusicPanel
 * - Placeholder "real" widget (simple) that can later use /api/music/posts?sort=trending
 * - For now: fetches newest artists as a stand-in
 *
 * Intended location:
 *   src/pages/music/components/TrendingMusicPanel.jsx
 */

export default function TrendingMusicPanel() {
